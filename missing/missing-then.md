...
Note: as a matter of fact, we don't even need an editor to create text files,
the text above was not inserted by an editor, although following is done via `vi` to save time:
